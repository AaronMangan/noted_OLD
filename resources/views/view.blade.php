    ...
    <div class="w-full prose prose-slate max-w-none">
        <div class="mx-auto max-w-7xl sm:px-2 lg:px-2">
            ...
            <div class="flex inline-flex items-center justify-center w-full">
                <a class="mr-2 text-xs text-gray-400 cursor-pointer" onclick='window.location="{{route('dashboard')}}"'>Home</a>
                <a class="mr-2 text-xs text-gray-400 cursor-pointer" onclick='window.location="{{route('settings.create', $page->id)}}"'>Settings</a>
            </div>
